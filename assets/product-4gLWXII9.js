import{g as r,s as o,a as s}from"./utils-_eg_pURR.js";import{P as c}from"./ProductData-ckpWzqDt.js";class i{constructor(a,d){this.productId=a,this.product={},this.dataSource=d}async init(){this.product=await this.dataSource.findProductById(this.productId),this.renderProductDetails(),document.getElementById("addToCart").addEventListener("click",this.addProductToCart.bind(this))}addProductToCart(){const a=r("so-cart")||[];a.push(this.product),o("so-cart",a)}renderProductDetails(){document.querySelector("main").innerHTML=e(this.product)}}function e(t){return`
